    ...
    >
      ...
      >
        <div className={classes.timeCont}>
          <h6
            style={{
              color: msg.senderId === loggedinUserId ? "yellow" : "green",
            }}
            ...
            {msg.senderId === loggedinUserId && (
              <>
                ...
                >
                  ...
                  <MenuItem onClick={handleDeleteForEvrybdy}>
        ...
        {msg.msgType === "txt" ? (
          <p className={classes.chatTxt}>{msg.msg}</p>
        ) : (
          ""
        )}
        {msg.msgType === "image" ? (
          <a href={msg.msg} target="_blanck">
            <img src={msg.msg} className={classes.chatImg} alt="img_upload" />
          </a>
        ) : (
          ""
        )}
        {msg.msgType === "file" ? (
          <a className={classes.a} href={msg.msg} target="_blanck">
            <AttachFileIcon />
          </a>
        ) : (
          ""
