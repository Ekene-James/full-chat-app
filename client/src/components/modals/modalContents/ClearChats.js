...
function ClearChats() {
  ...
  return (
    ...
    >
      ...
      <p>
        Doing so means you wont get all previous messages between this user
        subsequently, and likelyhood for it not to be deleted from the database
        due to company policy.
      </p>
      <p>
        If you wish to explicitly delete chats you have sent to this user, you
        can choose to do so individually.
      </p>
      ...
      <div>
        <Button
          ...
          sx={{
            mr: 1,
            pointerEvents: chatCtx.state.differentLoadings.isClearChatLoading
              ? "none"
              : "auto",
            opacity: chatCtx.state.differentLoadings.isClearChatLoading
              ? 0.6
              : 1,
          }}
        >
